export const API_CONFIG = {
  GOOGLE_APPS_SCRIPT_URL: import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbzoHlJCnfFnr40FPykL81DwkPXH0g4JHz6Krw5urkVw4iaQyxyxW6ggjnDwVBROX9a3aA/exec',
