export const API_CONFIG = {
  GOOGLE_APPS_SCRIPT_URL: import.meta.env.VITE_GOOGLE_APPS_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbzi5P5qd3M_k87lki9LqkEhfG4epPb63g-EahlNn4vUVzN3HN3peJ_kvhXdxm8uyc7PFw/exec',
